...
interface AnimatedRaysProps {
    ...
    /** Fuerza el modo oscuro (secciones oscuras en una página clara). */
    forceDark?: boolean;
}
...
export function AnimatedRays({
    ...
    const [isDark, setIsDark] = useState(Boolean(forceDark));
    ...
    // Paleta de marca: naranja, lima y ámbar en lugar del arcoíris azul/rosa.
