          ...
          return (
            <li
              ...
              className={cn(
                ...
                "border-b-2 border-[#0e0d0b]/10 dark:border-neutral-800",
                "last:border-b-0",
            ...
            >
              <button
                className={cn(
                  ...
                  isActive 
                    ? "border-l-[#ff5a00] dark:border-l-[#d6ff44] bg-white/70 dark:bg-neutral-800/30 text-neutral-900 dark:text-neutral-100 font-semibold" 
                    : "border-l-[#0e0d0b]/25 dark:border-l-neutral-700 bg-transparent text-[#0e0d0b] dark:text-neutral-400 hover:border-l-[#ff5a00] dark:hover:border-l-neutral-500 hover:text-neutral-900 dark:hover:text-neutral-200 hover:bg-neutral-50 dark:hover:bg-neutral-900/50"
                )}
              ...
              <div 
                className={cn(
                  ...
                  isActive ? "grid-rows-[1fr] border-l-[#ff5a00] dark:border-l-[#d6ff44] bg-white/70 dark:bg-neutral-800/30" : "grid-rows-[0fr] border-l-[#0e0d0b]/25 dark:border-l-neutral-700 bg-transparent"
                )}
              >
