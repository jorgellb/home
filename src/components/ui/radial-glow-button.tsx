...
export interface RadialGlowButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
  ...
  /** Si se indica, se renderiza como enlace (<a>) en lugar de <button>. */
  href?: string;
}
  ...
  return (
    <div className="relative inline-block">
      <style>{`
        ...
        @property --rg-color-1 { syntax: '<color>'; initial-value: #1a0900; inherits: false; }
        @property --rg-color-2 { syntax: '<color>'; initial-value: #7a2a00; inherits: false; }
        @property --rg-color-3 { syntax: '<color>'; initial-value: #ff5a00; inherits: false; }
        @property --rg-color-4 { syntax: '<color>'; initial-value: #d6ff44; inherits: false; }
        @property --rg-color-5 { syntax: '<color>'; initial-value: hsl(20 80% 3%); inherits: false; }
        @property --rg-border-angle { syntax: '<angle>'; initial-value: 180deg; inherits: true; }
        @property --rg-border-color-1 { syntax: '<color>'; initial-value: hsla(24, 100%, 85%, 0.7); inherits: true; }
        @property --rg-border-color-2 { syntax: '<color>'; initial-value: hsla(24, 60%, 85%, 0.25); inherits: true; }
        ...
        .rg-button:hover {
          ...
          --rg-border-color-1: hsla(75, 100%, 80%, 0.1);
          --rg-border-color-2: hsla(75, 80%, 80%, 0.35);
      ...
      {href ? (
        <a className={cn("rg-button", className)} href={href}>
