        ...
        <path
          ...
          className={cn(
            inverted
              ...
              : "fill-[#d6ff44] stroke-white dark:stroke-white/70",
          )}
          strokeWidth="2.1"
      ...
      <span
        className={cn(
          ...
          inverted
            ...
            : cn(
                "rounded-[22px] border border-white/60 bg-[#d6ff44] text-black",
                active
                  ? "shadow-[0_5px_18px_rgba(0,0,0,0.24),0_0_14px_rgba(214,255,68,0.18)]"
        ...
        {brands.map((brand, index) => (
          <motion.button
            ...
            className={cn(
              ...
              selected === index
                ? "border-[#b5c200]/45 text-[#a9b500] shadow-[inset_0_1px_rgba(255,255,255,.8),0_12px_28px_rgba(24,24,27,.14),0_0_22px_rgba(190,204,0,.12)] dark:border-[#d6ff44]/15 dark:text-[#d6ff44] dark:shadow-[inset_0_1px_rgba(255,255,255,.025),0_10px_24px_rgba(0,0,0,.34),0_0_18px_rgba(214,255,68,.045)]"
          ...
          >
            {selected === index && (
              <motion.span
                aria-hidden
                className="absolute inset-[12%] rounded-full bg-[#d6ff44]/20 blur-xl dark:bg-[#d6ff44]/[0.11]"
...
function InvoicePanel({ monthlyPrice, previousPrice, currency, locale, autoPlay, title, description }: InvoicePanelProps) {
  ...
  const invoices = [
    { label: "Técnico en plantilla", price: previousPrice, previousPrice: null, accent: false },
    { label: "Plan 360", price: monthlyPrice, previousPrice, accent: true },
  ];
        ...
        <AnimatePresence initial={false} mode="wait">
          ...
          >
            ...
            <div className="mt-2 flex items-baseline gap-2 whitespace-nowrap">
              <span className={cn("text-[26px] font-medium tracking-[-0.055em] @min-[520px]:text-[30px]", invoice.accent ? "text-[#a4b000] dark:text-[#d6ff44]" : "text-zinc-500 dark:text-[#8e8e8e]")}>
      ...
      <div className="absolute inset-x-0 top-0 flex h-[66%] items-center justify-center">
        ...
        <motion.button
          ...
          className={cn(
            ...
            arrowLit
              ? "border-[#d6ff44] text-[#050505] shadow-[0_10px_24px_rgba(24,24,27,.12)] dark:border-[#d6ff44] dark:text-[#050505] dark:shadow-[0_10px_24px_rgba(0,0,0,.28)]"
